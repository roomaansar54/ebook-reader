...
const _c0 = ["angularEpubViewerComponent"];
const EpubError = {
    OPEN_FILE: 0,
    READ_FILE: 1,
...
AngularEpubViewerComponent.ɵfac = function AngularEpubViewerComponent_Factory(t) { return new (t || AngularEpubViewerComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
AngularEpubViewerComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: AngularEpubViewerComponent, selectors: [["angular-epub-viewer"]], viewQuery: function AngularEpubViewerComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 5, ElementRef);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.root = _t.first);
    } }, inputs: { padding: "padding", autoPagination: "autoPagination", autoMetadata: "autoMetadata", autoTOC: "autoTOC" }, outputs: { onDocumentReady: "onDocumentReady", onChapterUnloaded: "onChapterUnloaded", onChapterDisplayed: "onChapterDisplayed", onLocationFound: "onLocationFound", onSearchFinished: "onSearchFinished", onPaginationComputed: "onPaginationComputed", onMetadataLoaded: "onMetadataLoaded", onTOCLoaded: "onTOCLoaded", onErrorOccurred: "onErrorOccurred" }, decls: 2, vars: 2, consts: [["id", "angularEpubViewerComponent"], ["angularEpubViewerComponent", ""]], template: function AngularEpubViewerComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", 0, 1);
    } if (rf & 2) {
        ɵngcc0.ɵɵstyleProp("padding", ctx.padding);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularEpubViewerComponent, [{
        type: Component,
        args: [{
    ...
    `],
    ...
    }], function () { return [{ type: ɵngcc0.NgZone }]; }, { padding: [{
            type: Input
        }], autoPagination: [{
            type: Input
        }], autoMetadata: [{
            ...
            type: Output,
            args: ['onDocumentReady']
        }], onChapterUnloaded: [{
            type: Output,
            args: ['onChapterUnloaded']
        }], onChapterDisplayed: [{
            type: Output,
            args: ['onChapterDisplayed']
        }], onLocationFound: [{
            type: Output,
            args: ['onLocationFound']
        }], onSearchFinished: [{
            type: Output,
            args: ['onSearchFinished']
        }], onPaginationComputed: [{
            type: Output,
            args: ['onPaginationComputed']
        }], onMetadataLoaded: [{
            type: Output,
            args: ['onMetadataLoaded']
        }], onTOCLoaded: [{
            type: Output,
            args: ['onTOCLoaded']
        }], onErrorOccurred: [{
            type: Output,
            args: ['onErrorOccurred']
        }], root: [{
            type: ViewChild,
            args: ['angularEpubViewerComponent', { read: ElementRef }]
        }] }); })();
...
AngularEpubViewerModule.ɵfac = function AngularEpubViewerModule_Factory(t) { return new (t || AngularEpubViewerModule)(); };
AngularEpubViewerModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: AngularEpubViewerModule });
AngularEpubViewerModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularEpubViewerModule, [{
        type: NgModule,
        args: [{
                imports: [],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AngularEpubViewerModule, { declarations: [AngularEpubViewerComponent], exports: [AngularEpubViewerComponent] }); })();
